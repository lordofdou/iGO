...
INSERT INTO `admin` VALUES (1,'admin','123456',NULL,1);
...
CREATE TABLE `category` (
  ...
  `detail` int(1) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detail` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `detail` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `detail` VALUES (1,'大分类'),(2,'小分类');
...
INSERT INTO `level` VALUES (1,'好'),(2,'中'),(3,'差');
...
INSERT INTO `orderstatus` VALUES (1,'待付款'),(2,'待发货'),(3,'待收货'),(4,'待评价'),(5,'退款／售后');
...
INSERT INTO `pop` VALUES (1,'推荐'),(2,'超实惠'),(3,'特色好货'),(4,'热门宝贝'),(5,'猜你喜欢');
...
CREATE TABLE `popular` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `popid` int(11) unsigned DEFAULT NULL,
...
INSERT INTO `type` VALUES (1,'帖子'),(2,'商品');
...
INSERT INTO `user` VALUES (1,'史总','male',NULL,'123456','12345678901',NULL,1);
...
-- Dump completed on 2016-03-03 16:50:21
